...
public class VanillaDbSpDriver implements SutDriver {
	...
	@Override
	public SutConnection connectToSut(GroupClient client) throws SQLException {
		SpDriver driver = new SpDriver();
		return new VanillaDbSpConnection(driver.connect(BenchmarkerParameters.SERVER_IP, null), client);
	}
}
